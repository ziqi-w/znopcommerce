...
/// </summary>
public partial class NopLocalRedirectResultExecutor : LocalRedirectResultExecutor
{
    #region Fields
    ...
    public override Task ExecuteAsync(ActionContext context, LocalRedirectResult result)
    {
