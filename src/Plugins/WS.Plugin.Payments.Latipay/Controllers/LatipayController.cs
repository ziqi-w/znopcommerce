...
using WS.Plugin.Payments.Latipay.Factories;
using WS.Plugin.Payments.Latipay.Models.Admin;
...
namespace WS.Plugin.Payments.Latipay.Controllers;
...
public class LatipayController : BasePaymentController
{
    ...
    private async Task SaveReconciliationTaskAsync(LatipaySettings settings)
    {
        ...
        var legacyScheduleTask = await _scheduleTaskService.GetTaskByTypeAsync(LatipayDefaults.LegacyReconciliationTaskType);
        if (scheduleTask is null)
        {
            ...
            scheduleTask.Type = LatipayDefaults.ReconciliationTaskType;
        }
        ...
        scheduleTask.Name = LatipayDefaults.ReconciliationTaskName;
        scheduleTask.Type = LatipayDefaults.ReconciliationTaskType;
